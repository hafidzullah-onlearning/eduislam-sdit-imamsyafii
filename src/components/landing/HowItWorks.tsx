...
const STEPS = [
  {
    icon: Settings,
    title: "Admin mengelola data sekolah",
    desc: "Yayasan dan admin sekolah menyiapkan kelas, guru, siswa, dan struktur biaya hanya sekali.",
  },
  {
    icon: Users,
    title: "Guru menginput tugas, hafalan, dan mood",
    desc: "Aktivitas harian, capaian Qur'an, dan kondisi emosional siswa tercatat di satu tempat.",
  },
  {
    icon: HeartHandshake,
    title: "Orang tua mendampingi & memberi feedback",
    desc: "Notifikasi real-time membuat orang tua tidak tertinggal perkembangan anak setiap hari.",
  },
  {
    icon: RefreshCw,
    title: "Semua data tersinkronisasi real-time",
    desc: "Dashboard yayasan, sekolah, dan keluarga selalu menampilkan data yang sama.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-lg text-muted-foreground">
            Empat langkah sederhana yang menghubungkan admin, guru, dan orang tua dalam satu alur
            kerja yang mulus.
          </p>
        </div>
