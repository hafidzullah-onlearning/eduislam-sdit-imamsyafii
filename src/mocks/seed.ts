...
export const seedUsers: User[] = [
  {
    id: "u-guru-1",
    name: "Ustadzah Aisyah Rahman",
    email: "aisyah@sdit.sch.id",
    role: "guru",
  ...
  {
    id: "u-ortu-1",
    name: "Bapak Ridho Nurhadi",
    email: "ridho@keluarga.id",
    role: "ortu",
...
export const seedSubmission: TugasSubmission[] = [
  ...
  { id: "sub-2", tugasId: "t-2", siswaId: "s-1", status: "belum", updatedAt: dOffset(-2) },
  {
    ...
    siswaId: "s-1",
    status: "selesai",
    komentarGuru: "Alhamdulillah lancar",
    updatedAt: dOffset(-1),
  },
...
export const seedTahfidz: Tahfidz[] = [
  ...
  },
  {
    ...
    catatan: "Ayat 30-35 perlu diperbaiki",
    tanggal: dOffset(-3),
    guruId: "u-guru-2",
  },
  {
...
export const seedPerilaku: Perilaku[] = [
  {
    id: "p-1",
    siswaId: "s-1",
    aspek: "karakter-islami",
    skor: 5,
    catatan: "Rajin shalat dhuha",
    tanggal: dOffset(-3),
    guruId: "u-guru-2",
  },
  {
...
export const seedInvoice: Invoice[] = [
  {
    ...
    jenis: "spp",
    jumlah: 850000,
    jatuhTempo: dOffset(-30),
    status: "lunas",
    metode: "va-bca",
    dibayarPada: dOffset(-28),
    referensi: "BCA-8823-991234",
  },
  {
    id: "inv-2",
    siswaId: "s-1",
  ...
  },
  {
    ...
    jenis: "kegiatan",
    jumlah: 250000,
    jatuhTempo: dOffset(-45),
    status: "lunas",
    metode: "qris",
    dibayarPada: dOffset(-44),
  },
  {
    id: "inv-4",
    siswaId: "s-2",
  ...
  },
  {
    ...
    jenis: "spp",
    jumlah: 850000,
    jatuhTempo: dOffset(-10),
    status: "lunas",
    metode: "gopay",
    dibayarPada: dOffset(-8),
  },
];
...
export const seedNotifikasi: Notifikasi[] = [
  {
    ...
    userId: "u-ortu-1",
    role: "ortu",
    judul: "Tugas baru Matematika",
    pesan: "Latihan perkalian 6 & 7, deadline 2 hari lagi.",
    tipe: "tugas",
    tanggal: dOffset(0),
    dibaca: false,
    link: "/app/tugas",
  },
  {
    ...
    userId: "u-ortu-1",
    role: "ortu",
    judul: "Tagihan SPP Juni 2026",
    pesan: "Rp 850.000 jatuh tempo dalam 5 hari.",
    tipe: "spp",
    tanggal: dOffset(-1),
    dibaca: false,
    link: "/app/spp",
  },
  {
    ...
    pesan: "Faris perlu mengulang QS. An-Naba ayat 30-35.",
    tipe: "tahfidz",
    tanggal: dOffset(-2),
    dibaca: true,
    link: "/app/tahfidz",
  },
  {
    ...
    userId: "u-guru-1",
    role: "guru",
    judul: "5 tugas menunggu diperiksa",
    pesan: "Buka menu Tugas untuk memeriksa.",
    tipe: "tugas",
    tanggal: dOffset(0),
    dibaca: false,
    link: "/app/tugas",
  },
  {
    ...
    userId: "u-admin-1",
    role: "admin",
    judul: "12 tagihan baru bulan Juni",
    pesan: "Generate tagihan berhasil.",
    tipe: "spp",
    tanggal: dOffset(-1),
    dibaca: false,
    link: "/app/admin/pembayaran",
  },
];
...
export const seedPengumuman: Pengumuman[] = [
  {
    ...
    isi: "Sekolah libur tanggal 6-8 Juni 2026.",
    targetRole: "semua",
    tanggal: dOffset(-4),
    createdBy: "u-admin-1",
  },
  {
    ...
    isi: "Diselenggarakan hari Sabtu depan pukul 08.00 WIB.",
    targetRole: "ortu",
    tanggal: dOffset(-2),
    createdBy: "u-admin-1",
  },
...
export const seedCatatan: CatatanGuru[] = [
  {
    id: "c-1",
    siswaId: "s-1",
    isi: "Faris sangat aktif dalam diskusi kelas hari ini, MasyaAllah.",
    tanggal: dOffset(-1),
    guruId: "u-guru-1",
    tipe: "positif",
  },
  {
    id: "c-2",
    siswaId: "s-1",
    isi: "Perlu latihan lebih untuk perkalian 7 dan 8.",
    tanggal: dOffset(-3),
    guruId: "u-guru-1",
